...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_location, 3, .production_id = 1),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_location, 4, .production_id = 1),
